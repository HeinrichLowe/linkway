    ...
    return (
        <>
            <div className="w-full h-full flex flex-col items-center">
                ...
                <div className="max-w-prose px-5 flex flex-col gap-10 md:px-0 md:flex-row md:gap-24">
                    <div className="w-full h-full">
                        <h3 className="text-center font-semibold">Resume EN</h3>
                        <div className="w-full h-full flex flex-col items-center gap-2">
                            <Link href={enResume} target="_black" rel="noopener noreferrer">
                                <Image className="w-full h-full my-2 hover:brightness-95 active:translate-y-1 duration-200" src={enResumeImage} alt="Resume EN" />
                            </Link>
                            <Link 
                                href={enResume}
                                download={"Paulo_Henrique_Silva_Leão_-_EN_Resume.pdf"} 
                                title="Download my EN resume" 
                                className="w-full px-4 py-1 text-center bg-white border border-stone-400 rounded-full hover:brightness-95 active:translate-y-1 duration-300"
                            >
                                Download
                            </Link>
                        </div>
                    ...
                    <div className="w-full h-full">
                        <h3 className="text-center font-semibold">Resume BR/PT</h3>
                        <div className="w-full h-full flex flex-col items-center gap-2">
                            <Link href={brResume} target="_black" rel="noopener noreferrer">
                                <Image className="w-full h-full my-2 hover:brightness-95 active:translate-y-1 duration-200" src={brResumeImage} alt="Resume EN" />
                            </Link>
                            <Link 
                                href={brResume}
                                download={"Paulo_Henrique_Silva_Leão_-_EN_Resume.pdf"} 
