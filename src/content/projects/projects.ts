...
export const projects: ProjectType[] = [
  {
    ...
    links: [
      {
        type: "backend",
        label: "Link to Back-end Code",
        url: "https://github.com/HeinrichLowe/NSN-Back.git",
      },
      {
        type: "frontend",
        label: "Link to Front-end Code",
        url: "https://github.com/HeinrichLowe/NSN-Front.git",
      },
    ],
    images: [
    ...
    links: [
      {
        type: "backend",
        label: "Link to Code",
        url: "https://github.com/HeinrichLowe/Learning-Log.git",
      },
    ],
    images: [
    ...
    links: [
      {
        type: "fullstack",
        label: "Link to Code",
        url: "https://github.com/HeinrichLowe/PetDevShop.git",
      },
    ],
    images: [
